...
// Ensure, that ingressInterfaceMock does implement typednetworkingv1.IngressInterface.
// If this is not the case, regenerate this file with moq.
var _ typednetworkingv1.IngressInterface = &ingressInterfaceMock{}

// ingressInterfaceMock is a mock implementation of typednetworkingv1.IngressInterface.
//
//	func TestSomethingThatUsesIngressInterface(t *testing.T) {
//
//		// make and configure a mocked typednetworkingv1.IngressInterface
//		mockedIngressInterface := &ingressInterfaceMock{
//			ApplyFunc: func(ctx context.Context, ingress *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*apinetworkingv1.Ingress, error) {
//				panic("mock out the Apply method")
//			},
//			ApplyStatusFunc: func(ctx context.Context, ingress *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*apinetworkingv1.Ingress, error) {
//				panic("mock out the ApplyStatus method")
//			},
//			CreateFunc: func(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.CreateOptions) (*apinetworkingv1.Ingress, error) {
...
//			},
//			GetFunc: func(ctx context.Context, name string, opts metav1.GetOptions) (*apinetworkingv1.Ingress, error) {
//				panic("mock out the Get method")
//			},
//			ListFunc: func(ctx context.Context, opts metav1.ListOptions) (*apinetworkingv1.IngressList, error) {
//				panic("mock out the List method")
//			},
//			PatchFunc: func(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*apinetworkingv1.Ingress, error) {
//				panic("mock out the Patch method")
//			},
//			UpdateFunc: func(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.UpdateOptions) (*apinetworkingv1.Ingress, error) {
//				panic("mock out the Update method")
//			},
//			UpdateStatusFunc: func(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.UpdateOptions) (*apinetworkingv1.Ingress, error) {
...
//		}
//
//		// use mockedIngressInterface in code that requires typednetworkingv1.IngressInterface
...
type ingressInterfaceMock struct {
	...
	calls struct {
		...
		Apply []struct {
			...
			Ingress *networkingv1.IngressApplyConfiguration
...
func (mock *ingressInterfaceMock) Apply(ctx context.Context, ingress *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*apinetworkingv1.Ingress, error) {
...
func (mock *ingressInterfaceMock) ApplyStatus(ctx context.Context, ingress *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*apinetworkingv1.Ingress, error) {
...
func (mock *ingressInterfaceMock) Create(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.CreateOptions) (*apinetworkingv1.Ingress, error) {
...
// Get calls GetFunc.
func (mock *ingressInterfaceMock) Get(ctx context.Context, name string, opts metav1.GetOptions) (*apinetworkingv1.Ingress, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ingressInterfaceMock) List(ctx context.Context, opts metav1.ListOptions) (*apinetworkingv1.IngressList, error) {
...
func (mock *ingressInterfaceMock) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*apinetworkingv1.Ingress, error) {
...
func (mock *ingressInterfaceMock) Update(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.UpdateOptions) (*apinetworkingv1.Ingress, error) {
...
func (mock *ingressInterfaceMock) UpdateStatus(ctx context.Context, ingress *apinetworkingv1.Ingress, opts metav1.UpdateOptions) (*apinetworkingv1.Ingress, error) {
