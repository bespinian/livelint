...
// Ensure, that deploymentInterfaceMock does implement typedappsv1.DeploymentInterface.
// If this is not the case, regenerate this file with moq.
var _ typedappsv1.DeploymentInterface = &deploymentInterfaceMock{}

// deploymentInterfaceMock is a mock implementation of typedappsv1.DeploymentInterface.
//
//	func TestSomethingThatUsesDeploymentInterface(t *testing.T) {
//
//		// make and configure a mocked typedappsv1.DeploymentInterface
//		mockedDeploymentInterface := &deploymentInterfaceMock{
//			ApplyFunc: func(ctx context.Context, deployment *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*apiappsv1.Deployment, error) {
//				panic("mock out the Apply method")
//			},
//			ApplyScaleFunc: func(ctx context.Context, deploymentName string, scale *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
//				panic("mock out the ApplyScale method")
//			},
//			ApplyStatusFunc: func(ctx context.Context, deployment *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*apiappsv1.Deployment, error) {
...
//			},
//			GetScaleFunc: func(ctx context.Context, deploymentName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
...
//			},
//			UpdateScaleFunc: func(ctx context.Context, deploymentName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
...
//		}
//
//		// use mockedDeploymentInterface in code that requires typedappsv1.DeploymentInterface
...
func (mock *deploymentInterfaceMock) Apply(ctx context.Context, deployment *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*apiappsv1.Deployment, error) {
...
func (mock *deploymentInterfaceMock) ApplyScale(ctx context.Context, deploymentName string, scale *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
...
func (mock *deploymentInterfaceMock) ApplyStatus(ctx context.Context, deployment *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*apiappsv1.Deployment, error) {
...
func (mock *deploymentInterfaceMock) GetScale(ctx context.Context, deploymentName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
...
func (mock *deploymentInterfaceMock) UpdateScale(ctx context.Context, deploymentName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
